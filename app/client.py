...
def main():
    ...
    test_get_block_by_known_hash("44617976010878707537334922413325691968490082213837833949115915130471944295996")
    ...
    test_get_blocks_by_known_timestamp("2021-05-24 01:45")
